...
app.controller("ctrl_ExamAPI", function($scope, $http, $interval, $location, $window, $routeParams){
    $scope.quiz = [];
    $scope.b = "alo";
    $scope.isLoading = false;
    /* const getLink = sessionStorage.getItem("linkToTest"); */
    $scope.getLink = $routeParams.idQuiz;
    const url = "https://621384a3f43692c9c6079d63.mockapi.io/subjects/"+$scope.getLink+"/quizs";
